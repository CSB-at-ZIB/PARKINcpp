...
# set file logger
rotatingFileHandler = logging.handlers.RotatingFileHandler("logtest.txt",maxBytes=1000000,backupCount=2)
...
#null_fds = [os.open("capture%s.txt" % x, os.O_RDWR) for x in xrange(2)]
