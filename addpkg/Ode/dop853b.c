/* KMBriggs 98 Dec 17 Version of dop853.c passing client data to fcn */
// 98 Dec 28 trying compensated summation with sum.c
...
/* #define sum2 sum0  */ /* uncomment this to NOT use compensated summation */
...
static double hinit (unsigned n, FcnEqDiff fcn, double x, double* y,
	      ...
	      double hmax, double* atoler, double* rtoler, int itoler, double *cd)
{
...
static int dopcor (unsigned n, FcnEqDiff fcn, double x, double* y, double xend,
		   ...
		   double beta, double fac1, double fac2, unsigned* icont, double *cd)
{
  ...
  iord = 8;
  if (h == 0.0)
    h = hinit (n, fcn, x, y, posneg, k1, k2, k3, iord, hmax, atoler, rtoler, itoler, cd);
  nfcn += 2;
  reject = 0;
  xold = x;
  ...
  while (1)
  {
    ...
    fcn (n, x+c2*h, yy1, k2, cd);
    for (i = 0; i < n; i++)
      yy1[i] = y[i] + h * (a31*k1[i] + a32*k2[i]);
    fcn (n, x+c3*h, yy1, k3, cd);
    for (i = 0; i < n; i++)
      yy1[i] = y[i] + h * (a41*k1[i] + a43*k3[i]);
    fcn (n, x+c4*h, yy1, k4, cd);
    for (i = 0; i <n; i++)
      yy1[i] = y[i] + h * sum2(3,a51*k1[i] , a53*k3[i] , a54*k4[i]);
    fcn (n, x+c5*h, yy1, k5, cd);
    for (i = 0; i < n; i++)
      yy1[i] = y[i] + h * sum2(3,a61*k1[i] , a64*k4[i] , a65*k5[i]);
    fcn (n, x+c6*h, yy1, k6, cd);
    for (i = 0; i < n; i++)
      yy1[i] = y[i] + h * sum2(4,a71*k1[i] , a74*k4[i] , a75*k5[i] , a76*k6[i]);
    fcn (n, x+c7*h, yy1, k7, cd);
    for (i = 0; i < n; i++)
      yy1[i] = y[i] + h * sum2(5,a81*k1[i] , a84*k4[i] , a85*k5[i] , a86*k6[i] ,
			  a87*k7[i]);
    fcn (n, x+c8*h, yy1, k8, cd);
    for (i = 0; i <n; i++)
      yy1[i] = y[i] + h * sum2(6,a91*k1[i] , a94*k4[i] , a95*k5[i] , a96*k6[i] ,
			  a97*k7[i] , a98*k8[i]);
    fcn (n, x+c9*h, yy1, k9, cd);
    for (i = 0; i < n; i++)
      yy1[i] = y[i] + h * sum2(7,a101*k1[i] , a104*k4[i] , a105*k5[i] , a106*k6[i] ,
			  a107*k7[i] , a108*k8[i] , a109*k9[i]);
    fcn (n, x+c10*h, yy1, k10, cd);
    for (i = 0; i < n; i++)
      yy1[i] = y[i] + h * sum2(8,a111*k1[i] , a114*k4[i] , a115*k5[i] , a116*k6[i] ,
			  a117*k7[i] , a118*k8[i] , a119*k9[i] , a1110*k10[i]);
    fcn (n, x+c11*h, yy1, k2, cd);
    xph = x + h;
    for (i = 0; i < n; i++)
      yy1[i] = y[i] + h * sum2(9,a121*k1[i] , a124*k4[i] , a125*k5[i] , a126*k6[i] ,
    ...
    for (i = 0; i < n; i++)
    {
      k4[i] = sum2(8,b1*k1[i] , b6*k6[i] , b7*k7[i] , b8*k8[i] , b9*k9[i] ,
	...
	erri = k4[i] - sum0(3,bhh1*k1[i] , bhh2*k9[i] , bhh3*k3[i]);
	sqr = erri / sk;
	err2 += sqr*sqr;
	erri = sum0(8,er1*k1[i] , er6*k6[i] , er7*k7[i] , er8*k8[i] , er9*k9[i] ,
	...
	if (nrds == n)
	  for (i = 0; i < n; i++)
	  {
	    ...
	    rcont5[i] = sum2(8,d41*k1[i] , d46*k6[i] + d47*k7[i] , d48*k8[i] ,
			d49*k9[i] , d410*k10[i] , d411*k2[i] , d412*k3[i]);
	    rcont6[i] = sum2(8,d51*k1[i] , d56*k6[i] + d57*k7[i] , d58*k8[i] ,
			d59*k9[i] , d510*k10[i] , d511*k2[i] , d512*k3[i]);
	    rcont7[i] = sum2(8,d61*k1[i] , d66*k6[i] + d67*k7[i] , d68*k8[i] ,
			d69*k9[i] , d610*k10[i] , d611*k2[i] , d612*k3[i]);
	    rcont8[i] = sum2(8,d71*k1[i] , d76*k6[i] + d77*k7[i] , d78*k8[i] ,
	  ...
	  for (j = 0; j < nrds; j++)
	  {
	    ...
	    rcont5[j] = sum2(8,d41*k1[i] , d46*k6[i] , d47*k7[i] , d48*k8[i] ,
			d49*k9[i] , d410*k10[i] , d411*k2[i] , d412*k3[i]);
	    rcont6[j] = sum2(8,d51*k1[i] , d56*k6[i] , d57*k7[i] , d58*k8[i] ,
			d59*k9[i] , d510*k10[i] , d511*k2[i] , d512*k3[i]);
	    rcont7[j] = sum2(8,d61*k1[i] , d66*k6[i] , d67*k7[i] , d68*k8[i] ,
			d69*k9[i] , d610*k10[i] , d611*k2[i] , d612*k3[i]);
	    rcont8[j] = sum2(8,d71*k1[i] , d76*k6[i] , d77*k7[i] , d78*k8[i] ,
			d79*k9[i] , d710*k10[i] , d711*k2[i] , d712*k3[i]);
	  }

	/* the next three function evaluations */
	for (i = 0; i < n; i++)
	  yy1[i] = y[i] + h * sum2(8,a141*k1[i] , a147*k7[i] , a148*k8[i] ,
			      a149*k9[i] , a1410*k10[i] , a1411*k2[i] ,
			      a1412*k3[i] , a1413*k4[i]);
	fcn (n, x+c14*h, yy1, k10, cd);
	for (i = 0; i < n; i++)
	  yy1[i] = y[i] + h * sum2(8,a151*k1[i] , a156*k6[i] , a157*k7[i] , a158*k8[i] ,
			      a1511*k2[i] , a1512*k3[i] , a1513*k4[i] ,
			      a1514*k10[i]);
	fcn (n, x+c15*h, yy1, k2, cd);
	for (i = 0; i < n; i++)
	  yy1[i] = y[i] + h * sum2(8,a161*k1[i] , a166*k6[i] , a167*k7[i] , a168*k8[i] ,
			      a169*k9[i] , a1613*k4[i] , a1614*k10[i] ,
			      a1615*k2[i]);
	fcn (n, x+c16*h, yy1, k3, cd);
	nfcn += 3;
	...
	if (nrds == n)
	  for (i = 0; i < n; i++)
	  {
	    rcont5[i] = h * sum2(5,rcont5[i] , d413*k4[i] , d414*k10[i] ,
			     d415*k2[i] , d416*k3[i]);
	    rcont6[i] = h * sum2(5,rcont6[i] , d513*k4[i] , d514*k10[i] ,
			     d515*k2[i] , d516*k3[i]);
	    rcont7[i] = h * sum2(5,rcont7[i] , d613*k4[i] , d614*k10[i] ,
			     d615*k2[i] , d616*k3[i]);
	    rcont8[i] = h * sum2(5,rcont8[i] , d713*k4[i] , d714*k10[i] ,
			     d715*k2[i] , d716*k3[i]);
	  }
        else
	  for (j = 0; j < nrds; j++)
	  {
	    i = icont[j];
	    rcont5[j] = h * sum2(5,rcont5[j] , d413*k4[i] , d414*k10[i] ,
			     d415*k2[i] , d416*k3[i]);
	    rcont6[j] = h * sum2(5,rcont6[j] , d513*k4[i] , d514*k10[i] ,
			     d515*k2[i] , d516*k3[i]);
	    rcont7[j] = h * sum2(5,rcont7[j] , d613*k4[i] , d614*k10[i] ,
			     d615*k2[i] , d616*k3[i]);
	    rcont8[j] = h * sum2(5,rcont8[j] , d713*k4[i] , d714*k10[i] ,
			     d715*k2[i] , d716*k3[i]);
	  }
      }
...
int dop853
 (unsigned n, FcnEqDiff fcn, double x, double* y, double xend, double* rtoler,
  ...
  long nmax, int meth, long nstiff, unsigned nrdens, unsigned* icont, unsigned licont, double *cd)
{
  int       arret, idid;
  unsigned  i;
  ...
  else
  {
    idid = dopcor (n, fcn, x, y, xend, hmax, h, rtoler, atoler, itoler, fileout,
		   solout, iout, nmax, uround, meth, nstiff, safe, beta, fac1, fac2, icont, cd);
    free (k10);
    free (k9);
    free (k8);
    free (k7);
